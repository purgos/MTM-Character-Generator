...
SPELLS = {
    "ACID RAIN": {
        ...
        "area_of_effect": "One or more connected 5-foot squares.",
    ...
    "ALLS CLEAR": {
        ...
        "area_of_effect": "The Caster’s Square(s)",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Allows the caster to remove any non-magical impediments in their square(s). This would include such items as pitons, ball bearings, spores from a creature, dust, dirt, etc. All items this spell can remove are subject to GM approval. This spell lasts a number of rounds equal to the gear die rolled"
    },
    ...
    "BURROW": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Caster grows claws and gains a burrowing speed of 15’ per round for a number of rounds equal to the gear die roll. A rank 7 or higher caster can burrow at a speed of 30’ per round. The claws cannot be used as a weapon nor can the caster move through or into other creatures. A roll of 10 or better is needed to burrow through stone. You cannot burrow through metal with this spell. This spell cannot be used in conjunction with Displacement or Mirror Image"
    },

    "CHAIN LIGHTNING": {
        "prerequisite": "Magic Aspect D10",
        "spell_components": ['E*', 'I', 'O'],
        "area_of_effect": "2-14 Creatures",
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per day.",
        "description": "Unleashes a bolt of electricity that arcs from one target to another affecting 2 targets at minimum plus an additional target per gear die rolled causing its gear die in damage to all affected creatures. A rank 7 or better caster can affect an additional target per rank. This spell can be cast every other round. CHARM MONSTER/PERSON (I, S) This spell allows the caster to compel the target to do their bidding. The target will not bring harm to themselves, but will obey any other verbal commands given to them for a number of rounds equal to the gear die rolled. All targets get a Magic save at the beginning of the original casters round to break the Charm effect with a DL of 11. The caster must remain within visual range of any targets and use a full round action to maintain the Charm. A rank 7 or higher caster can affect a number of targets equal to the gear die rolled and may use a Move Action to maintain the spell instead"
    },
    ...
    "COMFORT": {
        ...
        "duration": "1 Hour",
        "frequency": "This spell can be cast once per day.",
        "description": "This spell allows the caster to suffer no ill effects from natural extreme heat or cold for a period of 1 hour per gear die rolled. A rank 7 or greater caster can affect a number of targets equal to the gear die rolled"
    },
    ...
    "COMMON KNOWLEDGE": {
        ...
        "duration": "1 Hour",
        "frequency": "This spell can be cast once per day.",
        "description": "This spell improves the caster’s’ Gather Information check(s). Upon casting this spell, the caster may add +1 to their Gather Information skill check(s) per gear die rolled. A rank 7 or greater caster can cast this spell twice per day"
    },

    "CREATE PORTAL": {
        "prerequisite": "Magic Aspect D8",
        "spell_components": ['I', 'O'],
        "area_of_effect": "See Below",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Allows the caster to lay their hands on a 5x5x10 section of wall or a door and create a hole large enough to allow 1 medium sized being to pass through per round or allows one projectile or spell to pass through per round. A rank 7 or better caster can create a 10x10x20 opening and allow 2 medium creatures or 1 large creature through per round or two projectiles or two spells through per round. The spell lasts for a number of rounds equal to the gear die roll"
    },
    ...
    "DAZZLE": {
        ...
        "description": "Causes one man-sized enemy to hesitate for a number of rounds equal to the gear die roll. Victims take on the Dazed condition. Dazzled creatures can’t become undazzled unless attacked successfully with a melee or ranged weapon, a spell, (both doing full damage with no saves or armor bonuses) or a lessen effect spell. A rank 7 or better caster can affect a number of creatures equal to the gear die roll"
    },
    ...
    "DEATH": {
        ...
        "description": "Below Allows the caster to select one living target and attempt to steal its life force. The target immediately makes a death save with a + or – one per rank difference between the caster and the target. Failure results in immediate death. A partial success means the target takes the casters gear die multiplied by the casters rank in damage divided by 2 while a moderate success results in the target taking one half its current hit point total in damage while a total save results in the target instead taking on the sickened condition for a number of rounds equal to the casters gear die. This spell also causes the caster to take on the exhausted condition for a number of rounds equal to the gear die roll"
    },
    ...
    "DOWN THE DRAIN": {
        "prerequisite": "Magic Aspect D10",
        "spell_components": ['I', 'S'],
        "area_of_effect": "The Caster and One Opponent",
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
        "description": "When making a WM attack, if you successfully hit your opponent and do damage, any damage done to your opponent is immediately added to your HP Total as temporary hit points. You may gain 10HP per rank maximum from each casting. These temporary hit points last for a number of rounds equal to the gear die roll or until depleted.  A rank seven or better caster keeps these HP until they are depleted"
    },

    "DRAGON BREATH": {
        "prerequisite": "Magic Aspect D8",
        "spell_components": ['E', 'I', 'O'],
        "area_of_effect": "A 10’x10’ square or a line 4 squares long",
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per day.",
    ...
    "ENTANGLE": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Conjures a single 10’ long black tentacle that entangles one target and introduces the entangled condition. The spell lasts a number of rounds equal to the gear die roll. A rank 7 caster can conjure a number of tentacles and affect a number of targets equal to the gear die roll and may also move the tentacle(s) 30’ per move action. No creature may have more than one tentacle attacking/entangling them at a time. Each tentacle has 10hp and is immune to all spell effects"
    },
    ...
    "FIREBALL": {
        ...
        "area_of_effect": "One or More Connected Squares",
        "duration": "Instantaneous",
    ...
    "FORGET": {
        ...
        "area_of_effect": "One or Two Creatures",
        "duration": "Persistent",
        "frequency": "",
        "description": "Causes the target to forget all spells in any current gear die slots at a cost of one spell per 2 points rolled for a minimum of one and a maximum of 6. The spells forgotten go from lowest to highest gear die of spells remaining. These slots cannot be repopulated with spells unless the target takes a long rest (8+ hours). This spell can only be used once per encounter."
    },

    "GENTLE LANDING": {
        "prerequisite": "Magic Aspect D6",
        "spell_components": ['I', 'O', 'S'],
        "area_of_effect": "The Caster or one other target",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Choose either the caster or one other target within sight. A falling creature’s rate of descent slows to 60 feet per round for a number of rounds equal to the gear die roll. If the creature lands before the spell ends, it takes no falling damage and can land on its feet, and the spell ends for that creature. A rank 7 or greater caster can affect a number of targets equal to the gear die roll.  Gotta Have It (I) This spell allows the caster to cast any spell in their spell book when needed without having to have it prepared in either a Spell or Gear Die slot beforehand. The spell gained from this spell is subject to any limitations of the gained spell. The spell can only be at a D4, D6, or D8 level of effect. A Rank 7 or better caster can cast any spell from their spell book when needed at any Spell or Gear Die level.  A rank 7 or better caster can cast this spell once per encounter"
    },
    ...
    "GREATER HEALING": {
        ...
        "duration": "Instantaneous",
        "frequency": "",
        "description": "Restores twice its gear die in hit points plus caster rank to the person the caster chooses. A rank 7 or higher caster can cast this spell once per encounter per target. This spell can only be used once per encounter."
    },
    ...
    "GREATER MASS HEALING": {
        ...
        "description": "Restores twice its gear die in hit points plus caster rank to the casters entire party. A rank 7 or higher caster can cast this spell twice per encounter"
    },

    "HAIL STORM": {
        "prerequisite": "Magic Aspect D8",
        "spell_components": ['I'],
        "area_of_effect": "One or Two Connected Squares",
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
    ...
    "HASTE": {
        ...
        "area_of_effect": "The Caster or One Ally Duration: Persistent",
        "duration": "Persistent",
        "frequency": "Can be cast once per encounter but only once per day on any character.",
        "description": "Speeds up time for one person, increasing the number of actions they get to take that turn. This spell cannot be cast on animals or Spiritual Helpers. Upon successful casting, additional actions are granted at the cost of 4 points rolled per action with a minimum of one bonus action and a maximum of 3 bonus actions. Actions granted by this spell must be used by the end of the casters next turn"
    },
    ...
    "HEALALL": {
        ...
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per day.",
        "description": "Restores its die in hit points multiplied by caster rank to one person the caster chooses. A rank 7 or higher caster can cast this spell once per encounter"
    },
    ...
    "HEALING": {
        ...
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Restores its die in hit points plus caster rank to one person the caster chooses. A rank 7 or higher caster can cast this spell once per encounter per target"
    },

    "HEROISM": {
        "prerequisite": "Magic Aspect D8",
        "spell_components": ['I', 'S'],
        "area_of_effect": "The caster or one ally",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Grants a temporary +1 to Aspect Checks, Saving Throws, and/or Armor Checks according to the table below. A rank 7 or higher caster can cast this once per encounter.  1-4 +1 on aspect checks 5-8 +1 on saving throws 9-12 +1 on armor checks I Dare You To (I) This spell causes iron spikes to erupt from the targets body or armor. These spikes cause damage to any creature of equal or smaller size to the target each time they attack the target with any non- reach or natural weapon(s). The effect lasts a number of rounds equal to the gear die rolled. The spikes cause 1d4 damage per attack that the attacking creature makes against the recipient of this spell. A rank 7 or better caster can cast this spell once per encounter"
    },
    ...
    "ICY BLAST": {
        ...
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Allows the caster to fire a ray of ice that hits a number of targets equal to its gear die and doing its gear die in damage to its target(s). A rank 7 or better caster can cast this spell every other round"
    },
    ...
    "IMMOBILIZE": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Same as Dazzle except the held creatures can’t move or free itself automatically if attacked. When the affected creature is hit with a weapon or spell (which ignores armor and allows no save), the target(s) get a magic save to break the effect after each successful attack at DL11 to break the effect. The target is held fast until the spell is dispelled, he is attacked and then saves to break the effect, or until 24 hours elapse. A rank 7 caster can affect a number of creatures equal to the gear die roll"
    },

    "INCORPOREAL": {
        "prerequisite": "Magic Aspect D10",
        "spell_components": ['I'],
        "area_of_effect": "The Caster Duration: Non-Persistent",
        "duration": "Non-Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Allows the caster to make themselves and any gear they are carrying incorporeal immediately and gains the ability to walk through walls and other objects. The caster cannot interact with any creatures or objects or attack while in this form. No other beneficial spells or effects can exist or be cast on a creature that is Incorporeal. This spell lasts a number of rounds equal to the effect roll"
    },
    ...
    "LIGHTNING": {
        ...
        "area_of_effect": "A Single or Multiple",
        "duration": "Instantaneous",
    ...
    "LOCKED": {
        ...
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Allows the caster to lock a number of locks that the caster can see. This spell locks a number of locks equal to the effect roll. Locks closest to the caster are affected first"
    },
    ...
    "MAGICAL DARKNESS": {
        "prerequisite": "Magic Aspect D8",
        "spell_components": ['I', 'O'],
        "area_of_effect": "A 30x30x30 Cube",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Allows the caster to cast a darkness spell that darkens an area 30’x30’x10’ with inky black darkness. This spell lasts a number of hours equal to the effect roll. Spells cannot be cast into or out of an area under this effect by either the caster or anyone else. Spells that require concentration such as Phantom Weapon will also not function in the zone. This spell counteracts Magical Light. A rank 7 or better caster can cast this spell once per encounter"
    },

    "MAGICAL LIGHT": {
        "prerequisite": "Magic Aspect D8",
        "spell_components": ['I', 'O'],
        "area_of_effect": "A 30x30x10 Cube or One Inanimate",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Object Allows the caster to cast a light spell that illuminates an area with bright magical light. This spell can be cast on an inanimate object and lasts a number of hours equal to the effect roll. This spell counteracts Magical Darkness. A rank 7 or better caster can cast this spell once per encounter"
    },
    ...
    "MAGIC MISSILE": {
        ...
        "description": "Fires one bolt of arcane magic through the air doing its gear die plus 1 point per rank in damage. This spell is always cast successfully. A rank 7 or higher caster can fire a number of missiles equal to the gear die roll each hitting a separate target or a maximum of two missiles can be directed at a single target, but not both with the same spell. Each missiles gear die in damage must be rolled separately. In the event of a critically cast Magic Missile spell, ONLY the first missile will crit with the others doing normal damage and at Rank 7 or higher ONLY the first two missiles will crit, the others will do normal damage"
    },
    ...
    "MAGICAL SIGHT": {
        "prerequisite": "Magic Aspect D8",
        "spell_components": ['I', 'O'],
        "area_of_effect": "Casters Line of Vision",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
    ...
    "MASS HEALING": {
        ...
        "duration": "Instantaneous",
        "frequency": "Can be cast once per encounter.",
        "description": "Restores its gear die in hit points plus caster rank to the casters entire party. A rank 7 or higher caster can cast this spell twice per encounter"
    },
    ...
    "METAMAGIC": {
        ...
        "area_of_effect": "A Single Spell",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Allows the caster to manipulate the normal spell limitations of any non-persistent spell according to the below table based on the gear die roll. The spell only affects spells cast by the original caster. The caster can choose any ability at or below the gear die roll to manifest and apply it to any single spell. The metamagic must be used by the end of the casters next turn. This spell cannot be used in conjunction with Analyze.  A rank 7 or above caster can cast this spell once per encounter on himself or an ally. 1-2: Empower: increases the damage/effect of any non-persistent spell by 1.5 3-4: Enlarge: increases the spells affected area by 2. Does not affect non-area effect spells. 5-6: Extend: increases the duration of any non-persistent spell by 2. 7-8: Maximize: causes any variable effects on a non-persistent spell to be at maximum. 9-10: Quicken: allows the caster to cast two encounter level spells in a single round. 11-12: Repeat: allows the caster to cast a single non-persistent spell and have it auto cast again on the casters next round as a free action"
    },
    ...
    "MIRROR IMAGE": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Conjures one exact duplicate of the caster per rank. The images occupy the nearest squares to the caster. The caster can control how many images are created, however, the number of images cannot exceed the number of squares that the caster can see. The caster effectively “blinks” around from image to image though they can control this. Anyone attacking the character has a 50% chance to hit the character, (Below 51 hits an image), otherwise they hit an image instead and that image dissipates. The spell lasts a number of rounds equal to the gear die roll. This spell may not be used in conjunction with Burrow or Displacement. This spell may be cast once per encounter. More is Always Better (I) This spell allows the caster to give the target an additional pair of arms. The effect lasts for a number of rounds equal to the gear die rolled. The target gets an extra attack action as a benefit. If the target does not have weapons available for each new arm, they can instead make an Improvised Weapon attack with those arms as though they had the Improvised Weapon ability. If the target already has the improvised weapon ability, the additional arm attacks would instead be at 1d6 damage. A rank 7 or better caster can cast this spell once per encounter.  Mutable Form (I, 0, S) This spell allows the recipient to assume a mutable form that makes the target immune from critical hits for a number of rounds equal to the gear die rolled. A rank 7 or better caster can cast this spell on one ally instead. This spell can be cast once per day per target"
    },
    ...
    "NATURES STEP": {
        ...
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
        "description": "This spell can only be cast outdoors. This spell allows the caster to merge into any tree or bush and instantly reappear next to any other tree or bush within the casters sight when they first cast the spell. This uses only five’ of movement. This spell lasts a number of rounds equal to the gear die rolled. A rank seven or better caster can affect one ally as well"
    },
    ...
    "ODORLESS": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "This spell removes all scent from the caster and the gear they are carrying for a number of rounds equal to the gear die rolled. A rank 7 or higher caster can affect a number of allies equal to the gear die rolled"
    },
    ...
    "OPEN": {
        ...
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Allows the caster to unlock a number of locks that the caster can see. This spell unlocks a number of locks equal to the gear die roll. Locks closest to the caster are affected first"
    },
    ...
    "PARDON ME": {
        ...
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
        "description": "As a full round action, you attempt to interrupt an enemy spell caster from casting a spell at you. You choose one target and a particular spell or spell like effect and if that creature casts a spell/spell like effect at you, the spell caster must make two Magic Checks, if either fails, the spell does not affect you at all, though it would affect other potential targets if applicable. This only affects spells that directly target you either in a group or individually. Area of effect spells cannot be interrupted via this spell. The spell lasts for a number of rounds equal to the gear die rolled or until you are targeted and the caster is forced to make the disadvantaged Magic check. A rank 7 or better caster can negate two spells/spell like effects instead"
    },
    ...
    "PHANTOM WEAPON": {
        ...
        "duration": "Non-Persistent",
        "frequency": "",
        "description": "Conjures a single one-handed weapon of the casters choice that does its gear die in damage to a single target upon a successful hit. The caster can use the phantom weapon to attack the round after it is summoned. The caster uses their Magic Aspect to attack with this spell. A rank 4 caster can conjure a two-handed weapon. A 7th rank caster can conjure two one hand weapons per casting and can attack with the phantom weapons on the same round it is cast, OR the caster can opt for a single one or two hand weapon that can hit incorporeal/ethereal creatures without penalty. The caster must use an attack action each round or a move action to maintain the spell, otherwise it ends at the end of the original casters turn. If the Magic Aspect check roll to hit is a natural 1, the Phantom Weapon attacking will disappear. The spell lasts a number of rounds equal to the gear die roll. Spell may be cast once per encounter."
    },
    ...
    "SILENCE": {
        "prerequisite": "Magic Aspect D10",
        "spell_components": ['I', 'O', 'S'],
        "area_of_effect": "A 30x30x10 Cube",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Allows the caster to target an area they can see creating a 30x30x10 cube that blocks out all sound. Since spells require sound to be cast all spells cast within this area will fail. The effect lasts for a number of rounds equal to the effect roll. A rank 7 or higher caster can affect a 60x60x20 cube"
    },
    ...
    "SLEEP": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "Causes one enemy to fall asleep and take on the Prone condition, upon successful casting, for every 4 points rolled (minimum of one, maximum of 3). Targets may make a magic save to minimize the effect. Victims cannot take any action for 4 rounds when they are asleep, nor can they be awakened in any non-magical way. Attacking a sleeping creature in any way will break the spell instantly and allow them to react normally on their turn. A rank 7 or better caster can elect to affect a 30x30x10 cube instead. Can be cast once per encounter. SO THAT’S IT (I, O, S) This spell identifies any protective spell or spell like effects currently active on the target. The caster can choose any one effect and cancel it. If the effect is a natural or permanent in nature, the effect is merely suppressed instead for a number of rounds equal to the gear die roll. A rank seven or better caster can cast this once per encounter"
    },
    ...
    "SPECTRAL SERVANT": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "This spell summons a spectral servant under the casters control for a number of rounds equal to the gear die rolled. The servant cannot attack or be attacked. The servant can accomplish mundane tasks that the caster would normally have to do such as fetching items, cleaning, mending, lighting fires, etc. It performs these tasks to the best of its ability. A rank 7 or better caster can cast this spell once per rank per day"
    },
    ...
    "SUMMON SWARM": {
        ...
        "duration": "Non-Persistent",
        "frequency": "This spell can be cast once per encounter.",
        "description": "The caster summons a swarm of vermin which will fight a single, chosen foe that the caster can see for a number of rounds equal to the effect roll causing 1 point of damage per round (no save) and causing any creature who is swarmed to incur the Shaken condition for a number of rounds equal to the gear die roll. The creatures that make up the swarm can not cause any other effects than the damage and shaken condition. As a move action, the caster can elect to do ongoing damage each round or if the caster elects not to use the spell to cause ongoing damage in a given round, they can instead make a Magic aspect check as a free action to maintain the spell with a difficulty level of 7. If the affected creature dies, the original caster can redirect the swarm at any single target they can see using their standard attack action for whatever rounds remain from the original casting though the new target(s) get a save vs. the effect. Moving the swarm is always successful. A rank 7 or higher caster can affect two creatures per casting. The creatures’ summoned is equal to the gear die roll per the chart below.  1-2. Ants, Bats, Crabs 5-6. Centipedes, Locusts, Octopi9-10. Snakes, Wasps, Kuo-Toa 11-12. Spiders, Flies, Lizardfolk 3-4. Beetles, Bees, Crocodiles 7-8. Rats, Ravens, Sharks"
    },
    ...
    "SUSTENANCE": {
        ...
        "area_of_effect": "Within 30 feet",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "This spell allows the caster to create one day’s worth of rations and water for one person per gear die rolled. A rank 7 or higher caster can create one day’s worth of rations and water for a number of persons equal to the gear die rolled.  Take That (I, S) This spell allows the caster to possibly redirect the spell energy of any spell cast at them. The effect lasts until the end of the casters next turn. The caster can choose any ability at or below the gear die roll to manifest. The resulting effect must be used by the end of the casters next turn.  A rank 7 or above caster can cast this spell once per encounter on himself and the effect lasts for a number of rounds equal to one half the gear die rolled (rounded up). The following effects are possible: 1-4 Spell Deflection – Any spell cast at the caster deflects in a random direction (possibly hitting an ally). If this effect is used, the energy is redirected as follows: 1: Forward 2. Left 3. Right 4. Backward. The energy will continue on that path until it hits a target(s) or a wall or other object. 4-8 Spell Reflection – Any spell cast at the caster is immediately reflected back at the original caster who may then make a Magic save accordingly to avoid its effects with a -2 penalty to the Magic save. 9-12 Spell Absorption – Any spell cast at the caster is absorbed by the target and its energy can be used to allow the recipient of this extra spell energy to cast an extra spell on their next turn at the same gear die as the spell that was originally absorbed. This spell energy must be used by the end of the recipients next turn or it is forever lost"
    },
    ...
    "TELEKINESIS": {
        ...
        "duration": "Non-Persistent",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Allows the caster to move one small object up to about 10lbs in weight about at a rate of 5 feet per round. These objects cannot be used as weapons. This spell lasts a number of rounds equal to the effect roll. A rank 7 or better caster can move a number of objects equal to the gear die roll"
    },
    ...
    "THE FORECAST CALLS FOR": {
        ...
        "area_of_effect": "The Casters Field of Vision",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per week.",
        "description": "This spell can only be cast outdoors. The caster can alter the weather in the local area for a number of hours equal to the gear die rolled. The caster can choose from the following effects: 1. Temperature increase D4X10 degrees 2. Temperature decrease D4X10 degrees 3. Gentle Rain .1” per hour 4. Downpour, .25’ per hour 5. Light Wind up to 10 MPH 6. Windy, Steady 25MPH1 7. Light Snow .1’ per hour 8. Heavy Snow .25’ per hour 9. Sunny Skies 10. Sleet .1” per hour 11. Hail, Pea Size 12. Caster’s Choice"
    },
    ...
    "WHISPER IN THE WIND": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "This spell allows the caster to choose any one ally within line of sight and communicate a message in a whispery voice that only the target can hear. The target can reply as well and the response will also be in a whispery voice that only the caster can hear. This effect lasts for a number of rounds equal to the gear die rolled. A rank 7 or better caster can speak to a number of targets equal to the gear die rolled"
    },
    ...
    "WONDROUS EFFECT": {
        ...
        "duration": "Instantaneous",
        "frequency": "This spell can be cast once per encounter.",
        "description": "Allows the caster to produce minor magical effects that last a number of rounds equal to the gear die roll. You may choose from the effects below: 1. Create a harmless sensory effect, sparks, small puff of wind, faint music or voices, odors for a number of rounds equal to the gear die. 2. Instantaneously light or snuff out a candle, or small fire for a number of rounds equal to the gear die. 3. Instantaneously clean or soil a single object for a number of rounds equal to the gear die. 4. Instantaneously chill or warm up any liquid to 40 degrees-80 degrees for a number of rounds equal to the gear die. 5. Make a small mark or symbol appear on a surface or an object for a number of rounds equal to the gear die. 6. Create a small non-magical item that can fit in your hand for a number of rounds equal to the gear die."
    },
    ...
    "YOU'RE NOT SO TOUGH": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per encounter.",
        "description": "This spell allows the caster to grant themselves or one ally the ability to do extra damage to targets larger than them. For each size category above the size of the spells target that the creature is, the spell recipient adds +2 to the damage for each successful Warrior Melee attack against that target that they make. The effect lasts a number of rounds equal to the gear die rolled. A rank 7 or better caster adds +4 to the damage roll instead."
    },
    ...
    "YOU'RE SPECIAL": {
        ...
        "duration": "Persistent",
        "frequency": "This spell can be cast once per day.",
        "description": "This spell allows the caster to select any special ability from their Aspect that they initially put their D12 aspect die into and use that ability for a number of rounds equal to the gear die rolled. A rank 7 or better caster can instead choose any special ability from any list and use it for a number of rounds equal to the gear die rolled."
    },

    "YOU'RE WELCOME": {
        "prerequisite": "Magic Aspect D8",
        "spell_components": ['I', 'S'],
        "area_of_effect": "One ally",
        "duration": "Persistent",
        "frequency": "This spell can be cast once per encounter.",
