...
class GearDieTab:
    ...
    def set_data(self, data):
        """Set gear die data"""
        gear_die_slots = data.get('gearDieSlots', {})
        for die, slots in gear_die_slots.items():
            if die in self.gear_die_slots:
                self.gear_die_slots[die].set(str(slots))
        
        # Update character data
        self.character_data['gearDieSlots'] = gear_die_slots
        self.character_data['gearDieEntries'] = data.get('gearDieEntries', {})
